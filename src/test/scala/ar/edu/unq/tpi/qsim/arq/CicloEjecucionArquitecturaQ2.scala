...
class CicloEjecucionArquitecturaQ2 extends FlatSpec with Matchers {
  ...
  def parsers_resultados = new {
    var parser = Parser
    var resultadoQ2 = parser.ensamblar("src/main/resources/programaQ2.qsim")
    var resultadoQ2SintaxError = parser.ensamblar("src/main/resources/programaQ2SintaxError.qsim")
  }
