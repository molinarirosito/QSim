...
Como se observa en la figura \ref{ModoDireccionamiento} los modos de direccionamiento extienden del trait ModoDireccionamiento, donde se encuentran declarados mensajes necesarios para manejar todas las subclases \ojo{poliformicamente}{de manera polimórfica}. \ojo{Entre los cuales se encuentran los mensajes:}{Entre estos mensajes podemos enumerar:}
\begin{itemize}
\item  \textbf{representacionString:}
Devuelve la representación en string como código fuente, por ejemplo la representación de un \ojo{}{objeto?} \textbf{ADD(R0,R7)}, sería: \textbf{''ADD R0, R7''}
\item  \textbf{codigo:}
