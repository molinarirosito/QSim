...
\subsection{Ejecución paso a paso (falta revisar Mara)}
...
\graf{BusEntradaSalida_Memoria_CeldasPuertos}{Diagrama de clase del la BusEntradaSalida\_Memoria\_CeldasPuertos}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\graf{ModoDireccionamiento}{Diagrama de clase de la jerarquía de los modos de direccionamiento}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\graf{Instruccion_SinOperandos}{Detalle de clase InstruccionSinOperandos}
...
\graf{Instruccion_DosOperandos}{Diagrama de clase de la InstruccionDosOperandos}
