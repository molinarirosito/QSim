...
\ojo{Que el simulador admita la interacción con dispositivos de E/S. Para eso tenemos que modelar dispositivos como el teclado, impresora, monitor, etc.}{mas chamuyoooo}

\item \ojo{Implementar interrupcciones}{detallar}
