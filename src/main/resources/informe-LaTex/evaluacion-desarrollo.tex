...
En esta sección se describen los casos de prueba que se llevaron a cabo para verificar la funcionalidad de la aplicación.

\subsection{Chequeo de sintaxis en la distintas Qi}

Para chequear la sintaxis de cada \textbf{Arquitectura Qi}, el mecanismo es escribir un programa Qi en un archivo con extension .qsim y luego hacer que el objeto Parser lo procese para validar la sintaxis. 

Con este objetivo se realizaron dos casos de prueba por cada Qi:
\begin{enumerate}
