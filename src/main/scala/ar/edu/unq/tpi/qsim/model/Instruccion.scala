...
object Testuds extends App{
  ...
  val f = SUB(new Directo(new Inmediato(new W16("0567"))),new Inmediato(new W16("0005")))
  println(f.toString())
  println(f.representacionHexadecimal())
  println(f.tamanioHex)
  val r = MUL(R1,R4)  
  println(r.toString())
  println(r.representacionHexadecimal())
  println(r.tamanioHex)
  val s = MOV(new Directo(new Inmediato(new W16("1237"))),new Directo(new Inmediato(new W16("0567"))))
  println(s.toString())
  println(s.representacionHexadecimal())
  println(s.tamanioHex)
  val h = CMP(new Indirecto(new Directo(new Inmediato(new W16("1237")))),new Inmediato(new W16("0005")))
  println(h.toString())
  println(h.representacionHexadecimal())
  println(h.tamanioHex)
  val q = ADD(new Indirecto(new Directo(new Inmediato(new W16("1237")))),new Indirecto(new Directo(new Inmediato(new W16("1237")))))
  println(q.toString())
  println(q.representacionHexadecimal())
  println(q.tamanioHex)
}
